...
export type ChainInstance = Ethereum | Solana | TON;
...
export async function getConnector(
  ...
  if (connector === 'uniswap') {
    ...
    const { Dedust } = await import('../connectors/dedust/dedust');
    return Dedust.getInstance(network);
  } else {
